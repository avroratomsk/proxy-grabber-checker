    ...
    if proxy['https'] != 'socks5://':
        try:
            ...
            if str(response_json['subdivision1_name']) != 'None' or str(response_json['city_name']) != 'None':
                ...
                f = open('./result_socks5.txt', 'a', encoding="utf-8")
...
if __name__ == '__main__':
    ...
    f = open('./result_socks5.txt', 'w+', encoding="utf-8")
    f.write('')
    ...
    proxies = []
    with open('./result_socks5.txt', "r", encoding="utf-8") as file:
        for line in file:
            try:
                proxies.append(line.replace('\n', ''))
            except Exception as e:
